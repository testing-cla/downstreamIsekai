...
TEST(ProtocolFastRetransmissionSchedulerTest, WorkScheduler) {
  SimpleEnvironment env;
  FalconConfig config = DefaultConfigGenerator::DefaultFalconConfig(1);
  config.set_scheduler_variant(FalconConfig::EVENT_BASED_SCHEDULER);
...
TEST(ProtocolFastRetransmissionSchedulerTest, TestOpRateWorkScheduler) {
  SimpleEnvironment env;
  FalconConfig config = DefaultConfigGenerator::DefaultFalconConfig(1);
  config.set_scheduler_variant(FalconConfig::EVENT_BASED_SCHEDULER);
